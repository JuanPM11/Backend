    ...
    public class AutoMapperProfiles : Profile
    {
        ...
        public AutoMapperProfiles(GeometryFactory geometryFactory)
        {
            try
            {
                ...
                //mapeo de generocreacion hacia genero
                ...
                CreateMap<PeliculaCreacionDTO, Pelicula>().ForMember(x => x.Poster, opciones => opciones.Ignore()).ForMember(x => x.PeliculasGeneros, opciones => opciones.MapFrom(MapearPeliculasGeneros))
